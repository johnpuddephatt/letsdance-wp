<section
    class="fixed top-0 left-0 z-50 flex items-center justify-center w-screen h-screen transition-transform transform -translate-y-full bg-pink"
    :class="$store.siteLoading ? 'translate-y-0 delay-500 duration-1000 animate-rotate-hue' : 'duration-500 delay-200'">

    <div class="text-4xl font-bold !leading-tight text-center text-white !-translate-y-96 transform transition lg:text-6xl"
