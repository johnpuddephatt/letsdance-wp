<a class="col-span-1 no-underline duration-500 group project-item" href="{{ get_permalink($project->ID) }}" data-aos
    ...
    <h3
        class="mt-4 mb-1.5 text-base antialiased font-semibold leading-tight lg:leading-none text-gray-700 lg:mb-2 lg:text-lg">
        {!!
        $project->post_title !!}
    </h3>
    <p class="font-serif text-2xl antialiased leading-none text-gray-800 lg:text-3xl">{!!
