<header
  class="z-40 transition-transform delay-75 transform bg-white border-t border-gray-50  @if(isset($is_home) && $is_home) portrait:bg-black portrait:bg-opacity-50 portrait:border-t-0 portrait:absolute left-0 right-0 bottom-0 portrait:bg-transparent portrait:border-t-none  portrait:text-white @endif"
