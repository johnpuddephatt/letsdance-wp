<header
  class="z-40 transition-transform delay-75 transform bg-white  @if(isset($is_home) && $is_home) portrait:bg-black portrait:bg-opacity-60 portrait:absolute left-0 right-0 bottom-0  portrait:text-white @endif"
